            ...
            <div className="background">
                ...
                <div className="animals">
                    <div className="animals_right">
                        <img className="buaya" src="/assets/budayana/islands/Buaya.png"></img>
                        <img className="monyet" src="/assets/budayana/islands/Monyet.png"></img>
                    </div>

                    <div className="animals_left">
                        <img className="badak" src="/assets/budayana/islands/Badak.png"></img>
                        <img className="harimau" src="/assets/budayana/islands/Harimau.png"></img>
                    </div>
                </div>
