...
const PostTestPapua = () => {
    ...
    const questions = [
        ...
        {
            id: 1,
            question: "Siapakah tokoh utama dalam cerita ini?",
            options: [
                "Kepala Suku",
                "Biwar",
                "Naga Raksasa",
            ...
            correctAnswer: 1 // index of "Biwar" (B)
        },
        {
            id: 2,
            question: "Di mana Biwar tinggal?",
            options: [
                "Di istana kerajaan",
                "Di kota besar",
                "Di kampung kecil di tepi hutan",
                "Di atas gunung"
            ],
            correctAnswer: 2 // index of "Di kampung kecil di tepi hutan" (C)
        },
        {
            id: 3,
            question: "Makhluk apa yang mengganggu kehidupan warga kampung?",
            options: [
                "Harimau",
                "Raksasa",
                "Naga",
            ...
            correctAnswer: 2 // index of "Naga" (C)
        },

        // 🟡 MEDIUM LEVEL (4–7)
        {
            id: 4,
            question: "Apa yang sering dilakukan naga terhadap warga kampung?",
            options: [
                "Menjaga ladang",
                "Merusak ladang dan memakan ternak",
                "Membantu berburu",
                "Mengajari warga bertani"
            ],
            correctAnswer: 1 // index of "Merusak ladang dan memakan ternak" (B)
        },
        {
            id: 5,
            question: "Mengapa Biwar memutuskan melawan naga?",
            options: [
                "Ingin terkenal",
                "Ingin balas dendam",
                "Ingin melindungi kampung dan warganya",
                "Disuruh naga"
            ],
            correctAnswer: 2 // index of "Ingin melindungi kampung dan warganya" (C)
        },
        {
            id: 6,
            question: "Senjata apa saja yang dibawa Biwar?",
            options: [
                "Pedang dan perisai",
            ...
            correctAnswer: 1 // index of "Tombak, busur, dan panah" (B)
        },
        {
            id: 7,
            question: "Bagian tubuh naga mana yang pertama kali diserang Biwar dengan panah?",
            options: [
                "Sayap",
                "Leher",
                "Mata",
            ...
            correctAnswer: 2 // index of "Mata" (C)
        },

        // 🔴 HARD LEVEL (8–10)
        {
            id: 8,
            question: "Bagaimana Biwar menghindari serangan api naga?",
            options: [
                "Melompat ke sungai",
                "Berlari menjauh",
            ...
            correctAnswer: 2 // index of "Bersembunyi di balik batu" (C)
        },
        {
            id: 9,
            question: "Bagaimana Biwar mengalahkan naga untuk terakhir kalinya?",
            options: [
                "Memenggal kepalanya",
                "Menusuk jantungnya dengan tombak",
                "Menjatuhkannya ke jurang",
                "Membakarnya"
            ],
            correctAnswer: 1 // index of "Menusuk jantungnya dengan tombak" (B)
        },
        {
            id: 10,
            question: "Apa gelar yang diberikan kepada Biwar setelah kemenangan itu?",
            options: [
                "Biwar Sang Raja",
                "Biwar Sang Pemberani",
                "Biwar Sang Penjaga Hutan",
                "Biwar Sang Penakluk Naga"
            ],
            correctAnswer: 3 // index of "Biwar Sang Penakluk Naga" (D)
        }
    ];
                        ...
                        <button
                            onClick={() => {
                                if (window.confirm("Lanjut ke Materi?")) {
                                    window.location.href = "/cerita-rakyat/papua";
                                }
                            }}
