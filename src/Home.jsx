...
const islandData = [
  ...
  { id: "kalimantan", name: "Kalimantan", unlocked: false, left: "31%", top: "28%" },
  ...
  { id: "nusa", name: "Nusa Tenggara", unlocked: false, left: "60%", top: "72%" },
];
    ...
    <div className="page">
      ...
      {/* BACKGROUND ASSETS */}
       ...
       <div className="backgroundassets">
        ...
        {/* Character */}
        <img src="/assets/budayana/islands/bocah.png" alt="bocah" className="bocah" />
      ...
      {activeIsland && (
        <div className="popup-overlay" onClick={() => setActiveIsland(null)}>
          <div
            className={`popup ${activeIsland.unlocked ? "popup-unlocked" : "popup-locked"}`}
          ...
          >
            {activeIsland.unlocked ? (
              <div className="unlockedpopup">
                ...
                <div className="stage-grid">
                  {getStagesForIsland(activeIsland.id).map((stage, index) => (
                    <div  key={stage.title}
                          className={`stage-card ${stage.status === "locked" ? "locked" : ""}`}>
                      <img
              ...
              <div className="lockedpopup">
                ...
                <button className="ok-btn" onClick={() => setActiveIsland(null)}>
                  Oke!
                </button>
              </div>
            )}
