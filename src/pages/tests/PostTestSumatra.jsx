        ...
        <div className="min-h-screen bg-[#fdf4d7] flex items-center justify-center px-4 py-10">
            <div className="w-full max-w-6xl">
                ...
                <div className="relative flex items-center justify-between mb-6">
                    <button
                        onClick={handleExit}
                        className="w-12 h-12 rounded-full border-2 bg-white/85 border-[#2c2c2c] flex items-center justify-center transition hover:bg-black/5"
                    >
                        <ArrowLeft size={22} />
                    </button>
                    ...
                    <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full shadow-sm border-2 border-[#2c2c2c]">
                ...
                <div className="bg-[#f6c7a6] rounded-[28px] border border-[#f0b184] shadow-[0_18px_40px_rgba(0,0,0,0.12)] p-6">
                    ...
                    <div className="bg-white rounded-[26px] border-[3px] border-[#f19367] px-8 py-8 shadow-[0_12px_26px_rgba(0,0,0,0.08)]">
                        <div className="flex items-center gap-4 mb-8">
                            <div className="w-11 h-11 rounded-full bg-[#f19367] text-white font-bold flex items-center justify-center shadow-inner">
                                {currentQuestion + 1}
                            </div>
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left font-semibold rounded-[16px] border-[2.5px] px-5 py-4 transition-transform duration-150 ${selected
                                            ? "bg-[#f19367] text-white border-[#f19367] shadow-[0_10px_20px_rgba(241,147,103,0.25)]"
                                            : "bg-[#fff9f0] text-[#2a2a2a] border-[#f19367] hover:-translate-y-0.5"
                                            }`}
                                    >
                                        {opt}
                                    </button>
...
export default PostTestSumatra;
