...
const PostTestJawa = () => {
    ...
    const questions = [
        ...
        {
            id: 1,
            question: "Di kerajaan mana Roro Jonggrang tinggal?",
            options: [
                "Kerajaan Majapahit",
                "Kerajaan Prambanan",
                "Kerajaan Pengging",
            ...
            correctAnswer: 1 // index of "Kerajaan Prambanan" (B)
        },
        {
            id: 2,
            question: "Bagaimana sifat Roro Jonggrang menurut cerita?",
            options: [
                "Pemarah dan sombong",
                "Licik dan jahat",
                "Baik hati dan sopan",
            ...
            correctAnswer: 2 // index of "Baik hati dan sopan" (C)
        },
        {
            id: 3,
            question: "Siapakah Bandung Bondowoso?",
            options: [
                "Raja Prambanan",
                "Pangeran dari Majapahit",
                "Ksatria sakti dari Kerajaan Pengging",
                "Rakyat biasa"
            ],
            correctAnswer: 2 // index of "Ksatria sakti dari Kerajaan Pengging" (C)
        },

        // 🟡 MEDIUM LEVEL (4–7)
        {
            id: 4,
            question: "Mengapa Roro Jonggrang tidak langsung menolak lamaran Bandung Bondowoso?",
            options: [
                "Karena ia mencintainya",
                "Karena ia ingin menjadi ratu",
                "Karena takut pada kemarahan Bandung Bondowoso",
                "Karena disuruh rakyat"
            ],
            correctAnswer: 2 // index of "Karena takut pada kemarahan Bandung Bondowoso" (C)
        },
        {
            id: 5,
            question: "Apa syarat yang diajukan Roro Jonggrang untuk menikah?",
            options: [
                "Membangun istana baru",
                "Membangun seribu candi dalam satu malam",
                "Mengalahkan kerajaan lain",
                "Memberi emas dan harta"
            ],
            correctAnswer: 1 // index of "Membangun seribu candi dalam satu malam" (B)
        },
        {
            id: 6,
            ...
            correctAnswer: 2 // index of "Para jin" (C)
        },
        {
            id: 7,
            question: "Apa yang dilakukan Roro Jonggrang untuk menggagalkan pembangunan candi?",
            options: [
                "Merusak candi",
            ...
            correctAnswer: 1 // index of "Menyuruh wanita menumbuk padi dan menyalakan api" (B)
        },

        // 🔴 HARD LEVEL (8–10)
        {
            id: 8,
            question: "Mengapa para jin menghentikan pekerjaannya?",
            options: [
                "Karena kelelahan",
                "Karena diperintah Bandung Bondowoso",
                "Karena mengira pagi sudah tiba",
                "Karena takut pada Roro Jonggrang"
            ],
            correctAnswer: 2 // index of "Karena mengira pagi sudah tiba" (C)
        },
        {
            id: 9,
            ...
            correctAnswer: 2 // index of "999" (C)
        },
        {
            id: 10,
            question: "Apa akibat dari kemarahan Bandung Bondowoso?",
            options: [
                "Roro Jonggrang diusir",
                "Kerajaan hancur",
                "Roro Jonggrang dikutuk menjadi patung",
                "Bandung Bondowoso pergi"
            ],
            correctAnswer: 2 // index of "Roro Jonggrang dikutuk menjadi patung" (C)
        }
    ];
                        ...
                        <button
                            onClick={() => {
                                if (window.confirm("Lanjut ke Materi?")) {
                                    window.location.href = "/jawa-game";
                                }
                            }}
    ...
    return (
        <div className="min-h-screen bg-[#fdf4d7] flex items-center justify-center px-4 py-10">
            <div className="w-full max-w-6xl">
                ...
                {/* QUESTION CARD */}
                <div className="bg-[#f6c7a6] rounded-[28px] border border-[#f0b184] shadow-[0_18px_40px_rgba(0,0,0,0.12)] p-6">
                    ...
                    <div className="bg-white rounded-[26px] border-[3px] border-[#d87c4a] px-8 py-8 shadow-[0_12px_26px_rgba(0,0,0,0.08)]">
                        <div className="flex items-center gap-4 mb-8">
                            <div className="w-11 h-11 rounded-full bg-[#d87c4a] text-white font-bold flex items-center justify-center shadow-inner">
                                {currentQuestion + 1}
                            </div>
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left font-semibold rounded-[16px] border-[2.5px] px-5 py-4 transition-transform duration-150 ${selected
                                            ? "bg-[#d87c4a] text-white border-[#d87c4a] shadow-[0_10px_20px_rgba(216,124,74,0.25)]"
                                            : "bg-[#fff7f2] text-[#1f1f1f] border-[#d87c4a] hover:-translate-y-0.5"
                                            }`}
                                    >
                                        {opt}
                                    </button>
